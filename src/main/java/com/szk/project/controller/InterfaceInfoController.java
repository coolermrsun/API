...
import com.szk.project.common.*;
import com.szk.project.constant.CommonConstant;
import com.szk.project.exception.BusinessException;
import com.szk.project.model.dto.interfaceinfo.InterfaceInfoAddRequest;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        // 判断该接口是否可以调用
        com.szk.szkapiclientsdk.model.User user = new com.szk.szkapiclientsdk.model.User();
        user.setUsername("test");
        String username = szkApiClient.getUsernameByPost(user);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        SzkApiClient tempClient = new SzkApiClient(accessKey, secretKey);
        Gson gson = new Gson();
        com.szk.szkapiclientsdk.model.User user = gson.fromJson(userRequestParams, com.szk.szkapiclientsdk.model.User.class);
